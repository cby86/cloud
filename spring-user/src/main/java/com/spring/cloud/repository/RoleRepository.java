...
public interface RoleRepository extends BaseRepository<Role, String> {
    ...
    @Query(value = "select new com.spring.cloud.repository.component.ResourcePermit(a.url,a.versionNumber,group_concat(obj.code)) from Role obj left join obj.authentications a  where obj.deleted=0 and a.deleted=0 and a.authentionType=1 group by a.url")
