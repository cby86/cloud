...
public interface UserRepository extends BaseRepository<User,String> {
    ...
    @Query("select auth from User obj left join obj.roles role left join role.authentications auth where obj.deleted=false and auth is not null and obj.id=?1")
